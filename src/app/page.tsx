    ...
    <>
      ...
      <main>
        <section className="hero">
          <p className="eyebrow">어렵지 않은 AI 가이드</p>
          <h1>AI 쉬움에서 원하는 AI 도구를 골라 바로 확인하세요.</h1>
          <p>
            ChatGPT, Gemini, Claude, Cursor AI처럼 사람들이 자주 찾는 AI 도구의
            사용법, 가격, 오류 해결, 비교 정보를 쉽게 정리했습니다.
          </p>
        </section>
        ...
        <section className="section tool-picker" aria-labelledby="tool-picker-title">
          <div className="section-heading">
            ...
            <p>
              많이 쓰이는 AI부터 순서대로 정리했습니다. 원하는 도구를 선택하면
              관련 글 목록에서 사용법과 가격, 자주 묻는 질문을 볼 수 있습니다.
            </p>
          </div>
